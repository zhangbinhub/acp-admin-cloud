...
- 基于 Spring Cloud
- 该项目是前后端分离架构中的“后端部分”。前端工程[v4.1.1](https://github.com/zhangbin1010/acp-admin)
...
- [Acp 6.4.1](https://github.com/zhangbin1010/acp)
...
### （三）升级命令
```
    gradlew wrapper --gradle-version=6.1 --distribution-type=all
```

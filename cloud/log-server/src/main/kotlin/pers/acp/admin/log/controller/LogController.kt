...
constructor(
    ...
    fun findLoginLog(): ResponseEntity<List<LoginLogVo>> =
        CommonTools.getNowDateTime().withTimeAtStartOfDay().minusMonths(LogConstant.LOGIN_LOG_STATISTICS_MAX_MONTH)
            .let {
    ...
    @Throws(ServerException::class)
    fun queryFile(
        @ApiParam(value = "开始日期", required = true, example = "0")
